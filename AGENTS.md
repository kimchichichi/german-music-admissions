...
**3. 보호 파일 임의 수정 금지**
`universities.json` / `AGENTS.md` / `docs/*.md` / `.github/workflows/crawl.yml` / `snapshots/`
...
*다음 Codex에게: 작업 시작 전 해당 docs/ 파일을 반드시 읽을 것.*
